...
define('GMA_PATH', __DIR__ . DIRECTORY_SEPARATOR);
...
class GIcon {
    ...
    public function GIcon($img,
        ...
        $iconInfo = array('img'               => (string) $img,
            ...
            'shadowWidth'       => (int) _valueIfSet($shadowImgInfo[0], 0),
            'shadowHeight'      => (int) _valueIfSet($shadowImgInfo[1], 0),
...
/**
 * Return $value if $value is set, else return $default
 *
 ...
 * @return mixed
 */
function _valueIfSet(&$value, $default = null)
{
    if (isset($value)) {
        $out = $value;
    } else {
